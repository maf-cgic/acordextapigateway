...
class ApiGatewayWithAcordSchemaStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        # ACORD 103 endpoint
        applications_103 = api.root.add_resource("acord").add_resource("103")
        applications_103.add_method("POST", apigateway.LambdaIntegration(lambda_103, proxy=True))

        # ACORD 1125 endpoint
        applications_1125 = api.root.add_resource("acord").add_resource("1125")
        applications_1125.add_method("PUT", apigateway.LambdaIntegration(lambda_1125, proxy=True))

        # ACORD 203 endpoint
        applications_203 = api.root.add_resource("acord").add_resource("203")
